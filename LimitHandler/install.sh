...
wget -O /usr/bin/monitor_quota.py https://raw.githubusercontent.com/iz4nag1/vscripts/main/LimitHandler/monitor_quota.py

# Download autokill.py
echo "✅ Downloading monitor_autokill.py..."
wget -O /usr/bin/monitor_autokill.py https://raw.githubusercontent.com/iz4nag1/vscripts/main/LimitHandler/monitor_autokill.py
